...
public class ActivityJpaController implements Serializable {
    ...
    public ActivityJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Activity activity) throws RollbackFailureException, Exception {
    ...
    public void edit(Activity activity) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
